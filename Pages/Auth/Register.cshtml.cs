...
namespace Bestshop.Pages.Auth
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public void OnPost() 
        {
            ...
            string connectionString = "Data Source=NGUYENTANTAI;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";
